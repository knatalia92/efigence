this.onload = function() {
  ...
  function loadArray(arr) {
      ...
      for(var i = 0; i < Object.keys(arr.places).length; i++) {
        article += '<div class="row"><div class="col-md-3 col-md-offset-1 col-sm-3 col-xs-8"><img src="../public/img/gallery1.jpg" alt="miejscowka1"></div><div class="col-md-4 col-sm-6 col-xs-12"><article>';
        ...
        article += '<h1 class="rating"> Bardzo dobry '+ arr.places[i].score + '/10 </h1>'
